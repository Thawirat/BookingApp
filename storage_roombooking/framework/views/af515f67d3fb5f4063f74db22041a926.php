<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center">
                <form action="<?php echo e(route('manage_rooms.index')); ?>" method="GET" class="d-flex">
        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <div class="stat-card" onclick="showBuildings()">
                    ...
                    <div class="details">
                        <h3><?php echo e($totalBuildings); ?></h3>
            ...
            <div class="col-md-3">
                <div class="stat-card" onclick="showAvailableRooms()">
                    ...
                    <div class="details">
                        <h3><?php echo e($rooms->where('status_id', '2')->count()); ?></h3>
            ...
            <div class="col-md-3">
                <div class="stat-card" onclick="showUnavailableRooms()">
                    <i class="fas fa-door-closed icon"></i>
                    <div class="details">
                        <h3><?php echo e($rooms->where('status_id', '1')->count()); ?></h3>
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="container mx-auto pb-3 py-3">
                        <div class="grid grid-cols-4 gap-4">
                            <?php echo $__env->make('components.building-card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
                    <div class="d-flex justify-content-center p-4">
                        <?php echo e($buildings->appends(['search' => request('search')])->links('pagination::bootstrap-5')); ?>
    ...
    <?php echo $__env->make('components.modal.buildings.add-building', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.modal.buildings.edit-building', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/dashboard/manage_rooms.blade.php ENDPATH**/ ?>