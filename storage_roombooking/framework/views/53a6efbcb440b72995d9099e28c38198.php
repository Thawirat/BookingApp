    ...
    <table align="center" width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td align="center"
                ...
                <img src="<?php echo new \Illuminate\Support\EncodedHtmlString(asset('images/snru.png')); ?>" alt="Logo"
        ...
        <tr>
            <td style="padding:30px; color:#333;">
                ...
                <p style="font-size:16px; line-height:1.6;">
                    สวัสดี <strong><?php echo new \Illuminate\Support\EncodedHtmlString($user->name); ?></strong><br><br>
                    บัญชีของคุณ (<em><?php echo new \Illuminate\Support\EncodedHtmlString($user->email); ?></em>)
        ...
        <tr>
            <td align="center" style="padding:15px; background:#f8f9fa; font-size:12px; color:#666;">
                © <?php echo new \Illuminate\Support\EncodedHtmlString(date('Y')); ?> มหาวิทยาลัยราชภัฏสกลนคร
            </td>
        </tr>
    </table>
</body>
</html>
<?php /**PATH /var/www/html/resources/views/emails/users/approved.blade.php ENDPATH**/ ?>