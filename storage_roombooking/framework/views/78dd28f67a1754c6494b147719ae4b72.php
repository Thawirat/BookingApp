<div class="modal fade" id="addBuildingModal" tabindex="-1" aria-labelledby="addBuildingModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form id="addBuildingForm" action="<?php echo e(route('manage.buildings.store')); ?>" method="POST"
...
<?php /**PATH /var/www/html/resources/views/components/modal/buildings/add-building.blade.php ENDPATH**/ ?>