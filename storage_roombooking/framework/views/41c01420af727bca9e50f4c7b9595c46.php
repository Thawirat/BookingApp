<?php $__env->startSection('content'); ?>
    <div>
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>จัดการห้องในอาคาร: <?php echo e($building->building_name); ?></h2>
                <div class="d-flex align-items-center">
                    <form action="<?php echo e(route('manage_rooms.show', $building->id)); ?>" method="GET" class="d-flex">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <div class="stat-card">
                        ...
                        <div class="details">
                            <h3><?php echo e($unavailableCount); ?></h3>
                ...
                <div class="col-md-12">
                    <div class="card mb-4 shadow-sm">
                        <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                            <h5 class="mb-0">รายการห้องในอาคาร <?php echo e($building->building_name); ?></h5>
                            <div>
                                <a href="<?php echo e(route('manage_rooms.index')); ?>" class="btn btn-secondary btn-sm me-2">
                        ...
                        <div class="card-body p-0">
                                    ...
                                    <div class="col">
                                        <div class="card h-100 border-0 shadow-sm">
                                            <div class="position-relative">
                                                <img alt="ภาพห้อง <?php echo e($room->room_name); ?>" class="card-img-top"
                                                    src="<?php echo e($room->image ? asset('storage/' . $room->image) : asset('images/no-picture.jpg')); ?>"
                                                    style="height: 180px; object-fit: cover;" />
                                                <div class="position-absolute top-0 end-0 m-2">
                                                    <span
                                                        class="badge bg-<?php echo e($room->status_id == 2 ? 'success' : 'danger'); ?>">
                                            ...
                                            <div class="card-body px-3 py-2">
                                                <h5 class="card-title"><?php echo e($room->room_name); ?></h5>
                                                <p class="card-text text-muted small mb-2">
                                                    <i class="fas fa-building me-1"></i>
                                                    <?php echo e($building->building_name); ?>

                                                </p>
                                                <p class="card-text text-muted small mb-2">
                                                    <i class="fas fa-users me-1"></i>ความจุ: <?php echo e($room->capacity); ?> คน
                                                </p>
                                                <div class="btn-group w-100" role="group">
                                                    <a href="#" class="btn btn-sm btn-warning flex-grow-1"
                                                        onclick="handleEditRoomClick(<?php echo e($room->building_id); ?>, <?php echo e($room->room_id); ?>)">
                                                        <i class="fas fa-edit me-1"></i>แก้ไข
                                                    </a>
                                                    <button class="btn btn-sm btn-danger flex-grow-1"
                                                        onclick="confirmDeleteRoom(<?php echo e($room->building_id); ?>, <?php echo e($room->room_id); ?>, '<?php echo e($room->room_name); ?>')">
                            ...
                            <div class="d-flex justify-content-center p-4">
                                <?php echo e($rooms->appends(['search' => request('search')])->links('pagination::bootstrap-5')); ?>
    ...
    <?php echo $__env->make('components.modal.rooms.add-room', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.modal.rooms.edit-room', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/dashboard/rooms.blade.php ENDPATH**/ ?>