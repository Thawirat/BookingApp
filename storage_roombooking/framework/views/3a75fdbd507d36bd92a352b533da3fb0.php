    ...
    <table align="center" width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td align="center"
                ...
                <img src="<?php echo e(asset('images/snru.png')); ?>" alt="Logo"
            ...
            <td style="padding:30px; color:#333;">
                ...
                <div
                    ...
                    <ul style="padding-left:20px; margin-top:10px; margin-bottom:0;">
                        <li><strong>ผู้จอง:</strong> <?php echo e($booking->user->name); ?> (<?php echo e($booking->user->email); ?>)</li>
                        <li><strong>ห้อง:</strong> <?php echo e($booking->room->room_name); ?></li>
                        <li><strong>รหัสการจอง:</strong> <?php echo e($booking->booking_id); ?></li>
                        ...
                        <li><strong>วันที่จัด-เก็บสถานที่:</strong>
                            ...
                            <?php echo e(\Carbon\Carbon::parse($booking->teardown_date)->addYear(543)->format('d/m/Y')); ?></li>
                        ...
                        <li><strong>เวลา:</strong> <?php echo e(\Carbon\Carbon::parse($booking->booking_start)->format('H:i')); ?>

                            น. - <?php echo e(\Carbon\Carbon::parse($booking->booking_end)->format('H:i')); ?> น.</li>
                        <li><strong>วัตถุประสงค์:</strong> <?php echo e($booking->reason ?? 'ไม่ระบุ'); ?></li>
                        <li><strong>จำนวนผู้เข้าร่วม:</strong> <?php echo e($booking->participant_count ?? 'ไม่ระบุ'); ?> คน</li>
                    </ul>
                </div>
        ...
        <tr>
            <td align="center" style="padding:15px; background:#f8f9fa; font-size:12px; color:#666;">
                © <?php echo e(date('Y')); ?> มหาวิทยาลัยราชภัฎสกลนคร
            </td>
        </tr>
    </table>
</body>
...
<?php /**PATH /var/www/html/resources/views/emails/bookings/booking_created.blade.php ENDPATH**/ ?>