        ...
        <tr>
            <td style="padding:30px; color:#333;">
                ...
                <p style="font-size:16px; line-height:1.6;">
                    สวัสดี <strong><?php echo new \Illuminate\Support\EncodedHtmlString($user->name); ?></strong> (<em><?php echo new \Illuminate\Support\EncodedHtmlString($user->email); ?></em>)<br><br>
...
<?php /**PATH /var/www/html/resources/views/emails/users/rejected.blade.php ENDPATH**/ ?>