            ...
            <div class="col-md-10 col-lg-8">
                ...
                <div class="card shadow-sm mb-4 border-0">
                    ...
                    <div class="card-body text-center">
                        <img src="<?php echo e(Auth::user()->avatar_url ?? asset('images/profile-avatar2.png')); ?>" alt="User Avatar"
                            class="rounded-circle mb-3 mx-auto d-block"
                            style="width: 130px; height: 130px;">
                        <h5 class="mb-0"><?php echo e(Auth::user()->name ?? 'Guest'); ?></h5>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body ps-3 pe-3 pt-3 pb-3">
                        <form method="POST" action="<?php echo e(route('user.updateAll')); ?>" enctype="multipart/form-data"
                            id="profileForm">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="user_type" class="form-select" disabled>
                                        <option value="internal"
                                            <?php echo e(Auth::user()->user_type == 'internal' ? 'selected' : ''); ?>>บุคคลภายใน
                                        </option>
                                        <option value="external"
                                            <?php echo e(Auth::user()->user_type == 'external' ? 'selected' : ''); ?>>บุคคลภายนอก
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">ตำแหน่ง</label>
                                    <input type="text" name="position" value="<?php echo e(Auth::user()->position); ?>"
                                        class="form-control" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="department" value="<?php echo e(Auth::user()->department); ?>"
                                        class="form-control" readonly>
                                </div>
                                <div class="col-md-6 mb-3">
