<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid py-5"
        style="background-image: url('<?php echo e(asset('images/bg-1.jpg')); ?>'); background-size: cover; background-position: center; background-attachment: fixed;">
        <div class="container">
            <div class="row">
                    ...
                    <div class="card rounded-lg border-0 mb-4">
                        ...
                        <div class="card-body p-4">
                            <form action="<?php echo e(route('booking.store')); ?>" method="POST" id="bookingForm"
                                ...
                                <input type="hidden" name="building_id" value="<?php echo e($room->building_id); ?>">
                                <input type="hidden" name="room_name" value="<?php echo e($room->room_name); ?>">
                                <input type="hidden" name="building_name"
                                    value="<?php echo e($room->building->building_name ?? 'ไม่ระบุ'); ?>">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php if(auth()->check()): ?>
                                            <input class="form-control" type="text" name="external_position"
                                                value="<?php echo e(auth()->user()->position ?? ''); ?>" required>
                                        <?php else: ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php if(auth()->check()): ?>
                                            <input class="form-control" type="text" name="coordinator_department"
                                                value="<?php echo e(auth()->user()->department ?? ''); ?>" required>
                                        <?php else: ?>
                                            <input class="form-control" type="text" name="coordinator_department"
                                                required>
                                        <?php endif; ?>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <?php if($room->equipments->isEmpty()): ?>
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $room->equipments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo e($equipment->quantity); ?> รายการ</td>
                                                            </tr>
                                    ...
                                    <div class="col-md-12 mt-4 d-flex justify-content-between">
                                        <button type="button" class="btn btn-danger px-4"
                                            onclick="window.location.href='<?php echo e(route('rooms.index')); ?>'">
                                            ยกเลิก
                                        </button>
                ...
                <div class="col-lg-4">
                    <?php echo $__env->make('partials.room-info', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php echo $__env->make('partials.booking-summary', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const config = {
                holidaysWithNames: <?php echo json_encode($holidaysWithNames, 15, 512) ?>,
                bookedDetails: <?php echo json_encode($bookedDetails, 15, 512) ?>,
                disabledDays: <?php echo json_encode($disabledDays, 15, 512) ?>,
                bookedTimeSlots: <?php echo json_encode($bookedTimeSlots ?? [], 15, 512) ?>
            };
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/partials/booking-form.blade.php ENDPATH**/ ?>