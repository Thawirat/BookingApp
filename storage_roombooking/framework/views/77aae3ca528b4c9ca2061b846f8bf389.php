...
<div class="relative" x-data="{ open: false }">
    ...
    <div x-show="open" @click.away="open = false" x-transition x-cloak
        ...
        <form method="POST" action="<?php echo e(route('users.updateStatus', $user->id)); ?>">
            <?php echo csrf_field(); ?>
    ...
    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button type="submit" name="status" value="<?php echo e($value); ?>"
                        class="w-full text-left px-4 py-2 text-xs font-medium text-<?php echo e($data['color']); ?>-700 hover:bg-<?php echo e($data['color']); ?>-50
                                   transition-colors duration-100 flex items-center group rounded-md mx-1 mb-1">
                        <div class="w-2.5 h-2.5 bg-<?php echo e($data['color']); ?>-400 rounded-full mr-2">
                        </div>
...
<?php /**PATH /var/www/html/resources/views/components/dropdown/user-dropdown.blade.php ENDPATH**/ ?>